      ...
      <div>
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            className="font-mono text-xs uppercase tracking-tech text-[#C9A227] transition-colors hover:text-[#E8C547]"
          >
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
            {QTY_OPT.map((q) => {
              ...
              return (
                ...
                >
                  <span className="font-display text-2xl text-[#E8D5A3]">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {EXTRAS.map((extra) => {
            ...
            return (
              <label
                key={extra.key}
                className={`flex cursor-pointer items-center justify-between gap-3 px-4 py-3.5 focus-within:ring-2 focus-within:ring-[#E8C547]/60 focus-within:ring-offset-1 ${calcOption(checked)}`}
              >
                  ...
                  <span
                    ...
                    className={`grid h-5 w-5 place-items-center rounded border text-xs ${
                      checked
                        ...
                        : "border-[#C9A22733] text-transparent"
                    }`}
                  >
                    ✓
                  </span>
                  <span className="text-sm text-[#E8D5A3]">{extra.label}</span>
                </span>
